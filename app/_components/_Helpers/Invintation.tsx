...
function Invintation() {
  return (
    <div className="w-full h-fit flex items-center justify-center">
      <div className="flex relative overflow-hidden flex-col p-8 w-9/12 justify-center items-center bg-gradient-to-b from-white to-[#f2f9ff] rounded-2xl ">
        <svg
        ...
        <button className="absolute top-5 right-5 cursor-pointer hover:-translate-y-1 transition-all duration-200 w-fit h-fit p-1.5 rounded-full flex items-center justify-center border-[2px] z-15 border-white bg-[#d3e9f6] text-[#384355]">
          <Pencil />
        </button>
